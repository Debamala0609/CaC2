...
from Christcourier.views import index,service,about,reci,register,recipient,dashboard,contact,sdashboard,receive,pstatus,admin_db,parcel,plot_graph,Return_,retdet
